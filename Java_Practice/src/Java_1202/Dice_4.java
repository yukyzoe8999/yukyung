	...
	public static void main(String[] args) {
		try (// TODO Auto-generated method stub
			...
			if(sum==9 || sum==10) {
				...
				System.out.println("주사위를 한번 더 굴려주세요");
				int num_3= sc.nextInt();
				
				int sum_2 = 0;
				
				double dice_3 = Math.random();
				int dice_num_3=(int)(dice_3*num_3)+1;
				
				if(dice_num_3>num_3) { 
					dice_num_3 = (dice_num_3-1);
					System.out.println("다시던진 주사위 값은" + dice_num_3);
				}
				else {
					System.out.println("다시던진 주사위 값은" + dice_num_3);
				
					sum_2 = (sum - dice_num_3);
				System.out.println("결과 값은" +sum_2);
